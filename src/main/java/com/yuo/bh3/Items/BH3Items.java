...
public class BH3Items {
	...
	// 武器
	public static RegistryObject<Item> AXYW = ITEMS.register("bh3_axyw", () -> new BH3WeaponSickle(WeaponAttributes.AXYW));
	public static RegistryObject<Item> BAX = ITEMS.register("bh3_bax", () -> new BH3WeaponSickle(WeaponAttributes.BAX));
	public static RegistryObject<Item> BAZF = ITEMS.register("bh3_bazf", () -> new BH3WeaponSickle(WeaponAttributes.BAZF));
	public static RegistryObject<Item> BAZFL = ITEMS.register("bh3_bazfl", () -> new BH3WeaponSickle(WeaponAttributes.BAZFL));
	public static RegistryObject<Item> CBZ = ITEMS.register("bh3_cbz", () -> new BH3WeaponSword(WeaponAttributes.CBZ));
	public static RegistryObject<Item> CNZJ = ITEMS.register("bh3_cnzj", () -> new BH3WeaponSword(WeaponAttributes.CNZJ));
	public static RegistryObject<Item> CNZY = ITEMS.register("bh3_cnzy", () -> new BH3WeaponSword(WeaponAttributes.CNZY));
	public static RegistryObject<Item> CRY = ITEMS.register("bh3_cry", () -> new BH3WeaponSword(WeaponAttributes.CRY));
	public static RegistryObject<Item> DZQL = ITEMS.register("bh3_dzql", () -> new BH3WeaponSword(WeaponAttributes.DZQL));
	public static RegistryObject<Item> DZQLM = ITEMS.register("bh3_dzqlm", () -> new BH3WeaponSword(WeaponAttributes.DZQLM));
	public static RegistryObject<Item> FLD = ITEMS.register("bh3_fld", () -> new BH3WeaponSword(WeaponAttributes.FLD));
	public static RegistryObject<Item> FNMZ = ITEMS.register("bh3_fnmz", () -> new BH3WeaponLance(WeaponAttributes.FNMZ));
	public static RegistryObject<Item> FNMZC = ITEMS.register("bh3_fnmzc", () -> new BH3WeaponLance(WeaponAttributes.FNMZC));
	public static RegistryObject<Item> HSZS = ITEMS.register("bh3_hszs", () -> new BH3WeaponSickle(WeaponAttributes.HSZS));
	public static RegistryObject<Item> HYBH = ITEMS.register("bh3_hybh", () -> new BH3WeaponLance(WeaponAttributes.HYBH));
	public static RegistryObject<Item> HYBHC = ITEMS.register("bh3_hybhc", () -> new BH3WeaponLance(WeaponAttributes.HYBHC));
	public static RegistryObject<Item> HYD = ITEMS.register("bh3_hyd", () -> new BH3WeaponSword(WeaponAttributes.HYD));
	public static RegistryObject<Item> JM = ITEMS.register("bh3_jm", () -> new BH3WeaponBigSword(WeaponAttributes.JM));
	public static RegistryObject<Item> JMWJ = ITEMS.register("bh3_jmwj", () -> new BH3WeaponBigSword(WeaponAttributes.JMWJ));
	public static RegistryObject<Item> MFXX = ITEMS.register("bh3_mfxx", () -> new BH3WeaponSickle(WeaponAttributes.MFXX));
	public static RegistryObject<Item> NYJ = ITEMS.register("bh3_nyj", () -> new BH3WeaponBigSword(WeaponAttributes.NYJ));
	public static RegistryObject<Item> RMZ = ITEMS.register("bh3_rmz", () -> new BH3WeaponLance(WeaponAttributes.RMZ));
	public static RegistryObject<Item> SYJ = ITEMS.register("bh3_syj", () -> new BH3WeaponBigSword(WeaponAttributes.SYJ));
	public static RegistryObject<Item> SYZ = ITEMS.register("bh3_syz", () -> new BH3WeaponSickle(WeaponAttributes.SYZ));
	public static RegistryObject<Item> TJZJ = ITEMS.register("bh3_tjzj", () -> new BH3WeaponSword(WeaponAttributes.TJZJ));
	public static RegistryObject<Item> TJZY = ITEMS.register("bh3_tjzy", () -> new BH3WeaponSword(WeaponAttributes.TJZY));
	public static RegistryObject<Item> TSZS = ITEMS.register("bh3_tszs", () -> new BH3WeaponSickle(WeaponAttributes.TSZS));
	public static RegistryObject<Item> WSDFH = ITEMS.register("bh3_wsdfh", () -> new BH3WeaponBow(WeaponAttributes.WSDFH));
	public static RegistryObject<Item> WSDFHA = ITEMS.register("bh3_wsdfha", () -> new BH3WeaponBow(WeaponAttributes.WSDFHA));
	public static RegistryObject<Item> XSZJ = ITEMS.register("bh3_xszj", () -> new BH3WeaponSickle(WeaponAttributes.XSZJ));
	public static RegistryObject<Item> XSZY = ITEMS.register("bh3_xszy", () -> new BH3WeaponSickle(WeaponAttributes.XSZY));
	public static RegistryObject<Item> XYZM = ITEMS.register("bh3_xyzm", () -> new BH3WeaponSickle(WeaponAttributes.XYZM));
	public static RegistryObject<Item> XYZNY = ITEMS.register("bh3_xyzmy", () -> new BH3WeaponSickle(WeaponAttributes.XYZMY));
	public static RegistryObject<Item> YJZHLE = ITEMS.register("bh3_yjzhle", () -> new BH3WeaponLance(WeaponAttributes.YJZHLE));
	public static RegistryObject<Item> YLD = ITEMS.register("bh3_yld", () -> new BH3WeaponSword(WeaponAttributes.YLD));
	public static RegistryObject<Item> YYQW = ITEMS.register("bh3_yyqw", () -> new BH3WeaponSword(WeaponAttributes.YYQW));
	public static RegistryObject<Item> YYQWX = ITEMS.register("bh3_yyqwx", () -> new BH3WeaponSword(WeaponAttributes.YYQWX));
	public static RegistryObject<Item> ZCB = ITEMS.register("bh3_zcb", () -> new BH3WeaponSword(WeaponAttributes.ZCB));
	public static RegistryObject<Item> ZJZHLE = ITEMS.register("bh3_zjzhle", () -> new BH3WeaponLance(WeaponAttributes.ZJZHLE));
	public static RegistryObject<Item> ZWZJ = ITEMS.register("bh3_zwzj", () -> new BH3WeaponBow(WeaponAttributes.ZWZJ));
	public static RegistryObject<Item> ZWZY = ITEMS.register("bh3_zwzy", () -> new BH3WeaponBow(WeaponAttributes.ZWZY));
	public static RegistryObject<Item> ZXX = ITEMS.register("bh3_zxx", () -> new BH3WeaponLance(WeaponAttributes.ZXX));
	public static RegistryObject<Item> ZYDATJN = ITEMS.register("bh3_zydatjn", () -> new BH3WeaponLance(WeaponAttributes.ZYDATJN));
	public static RegistryObject<Item> ZYDHG = ITEMS.register("bh3_zydhg", () -> new BH3WeaponLance(WeaponAttributes.ZYDHG));
